defmodule Day02Test do
  ...
  test "test simulate with v1 policies" do
    {:ok, sample_data} = File.read("resources/day_02/day_02.sample")
    sample_elf_strategy_guide = Day02.parse_to_elf_strategy_guide(sample_data)
    sample_score = 15

    assert sample_score == Day02.simulate(sample_elf_strategy_guide)
  end

  test "test simulate with v2 policies" do
    {:ok, sample_data} = File.read("resources/day_02/day_02.sample")
    sample_elf_strategy_guide = Day02.parse_to_elf_strategy_guide(sample_data)
    sample_score = 12

    assert sample_score == Day02.simulate(sample_elf_strategy_guide, :v2)
  end
end
